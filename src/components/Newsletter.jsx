        ...
        <>
            <Wrapper className="!px-0 bg-[#60BA96] rounded-lg pt-12 !pb-0 !my-10">
                <div className="w-[90%] mx-auto flex gap-10">
                    <div className="text w-[70%] !pb-10">
                        <div className='flex flex-col items-start justify-center h-full'>
                        <h2 className='text-5xl text-white font-semibold mb-6'>Stay home & get your daily <br />needs from our shop</h2>
                        <p className='text-2xl text-white py-3'>Start You'r Daily Shopping with <span className='font-bold'> Falcon Fresh</span></p>
                        <div className='newsletter_wrapper rounded-full relative w-full max-w-[600px] mt-6'>
                            ...
                            <Button className="bg-[--primeColor] text-xl h-[60px] rounded-full px-10 absolute top-0 right-0">Subscribe</Button>
                        </div>
                        </div>
